...
1. **Authentication** — verify that you're talking to the real server.
2. **Confidentiality** — prevent others from reading your data.
3. **Integrity** — prevent others from modifying your data.
...
The random value is one of the inputs used during the TLS handshake and key derivation.
...
For example, the client creates:
